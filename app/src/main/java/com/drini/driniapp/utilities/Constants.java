...
public class Constants {
    public static final String KEY_PREFERENCE_NAME = "DriniPreference";
    public static final String KEY_HISTORY_IMAGES = "imgHistory";
    ...
    public static final String KEY_GLASS_TYPE = "glassType";
}
